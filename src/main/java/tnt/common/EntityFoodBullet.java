...
public class EntityFoodBullet extends Entity
{
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public EntityFoodBullet(World world)
    {
        super(world);
        this.xTile = -1;
        this.yTile = -1;
    ...
    public EntityFoodBullet(World world, EntityLivingBase entityliving, float speed)
    {
        super(world);
        this.xTile = -1;
        this.yTile = -1;
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    if(this.getFoodItem(this.getFoodID()) instanceof ItemFood)
                    {
                    	
                    ItemFood food = (ItemFood)this.getFoodItem(this.getFoodID());
                    if (movingobjectposition.entityHit.attackEntityFrom(TNTDamageSource.causeBulletDamage(this, this.shootingEntity), food.getHealAmount()))
                    {
                    	if(!worldObj.isRemote)
                    	{
                    		this.dropItem(this.getFoodID(), 1);
                    	}
                    ...
                    else if (movingobjectposition.entityHit.attackEntityFrom(TNTDamageSource.causeBulletDamage(this, this.shootingEntity), 30.0F))
                    {
                     	if(!worldObj.isRemote)
                    	{
                    		this.dropItem(this.getFoodID(), 1);
    ...
    public static Item getFoodItem(int i)
    {
    ...
    public void setFoodID(int par1)
    {
    ...
    public void writeEntityToNBT(NBTTagCompound nbttagcompound)
    {
        ...
        nbttagcompound.setInteger("food", (Integer)this.getFoodID());
    }
    ...
    public void readEntityFromNBT(NBTTagCompound nbttagcompound)
    {
        ...
        if (nbttagcompound.hasKey("food"))
        {
            int b0 = nbttagcompound.getInteger("food");
            this.setFoodID(b0);
        }
    }
