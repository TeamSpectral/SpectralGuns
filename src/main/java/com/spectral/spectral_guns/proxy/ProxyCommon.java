...
public class ProxyCommon
{
	...
	private void recipes()
	{
		...
		this.registerGear(M.gear_wood, Item.getItemFromBlock(Blocks.planks));
		...
		GameRegistry.addShapedRecipe(new ItemStack(M.container, 4), new Object[]
			{
					"OTO",
					"G G",
					"OOO",
					...
					'T',
					Item.getItemFromBlock(Blocks.iron_trapdoor),
					'G',
					Item.getItemFromBlock(Blocks.glass_pane)
			});
		GameRegistry.addShapedRecipe(new ItemStack(M.lens_convex, 5), new Object[]
			{
					" G ",
					"GGG",
					" G ",
		...
		GameRegistry.addShapedRecipe(new ItemStack(M.lens_concave, 7), new Object[]
			{
					"GGG",
					" G ",
					"GGG",
		...
		GameRegistry.addShapedRecipe(new ItemStack(M.prism), new Object[]
			{
					" G ", "GGG", 'G', Item.getItemFromBlock(Blocks.glass_pane)
			});
		GameRegistry.addShapedRecipe(new ItemStack(M.eyepiece), new Object[]
			{
					" I ",
					"lLl",
					" I ",
		...
		GameRegistry.addShapedRecipe(new ItemStack(M.laser_diode_green), new Object[]
			{
					"IGr",
					"leg",
					"IGc",
		...
		GameRegistry.addShapedRecipe(new ItemStack(M.laser_diode_red), new Object[]
			{
					"IGr",
					"leg",
					"IGc",
		...
		GameRegistry.addShapedRecipe(new ItemStack(M.laser_diode_green_strong), new Object[]
			{
					"IGr",
					"leg",
					"IGc",
		...
		GameRegistry.addShapedRecipe(new ItemStack(M.laser_diode_red_strong), new Object[]
			{
					"IGr",
					"leg",
					"IGc",
		...
		GameRegistry.addShapedRecipe(new ItemStack(M.shuriken, 8), new Object[]
			{
					"I I",
					" i ",
					"I I",
	...
	{
		GameRegistry.addShapedRecipe(new ItemStack(bar, 1), new Object[]
			{
					"NNN", "NNN", "NNN", 'N', nugget
			});
		GameRegistry.addShapedRecipe(new ItemStack(nugget, 9), new Object[]
			{
					"B", 'B', bar
			});
	}
	...
	{
		GameRegistry.addShapedRecipe(new ItemStack(gear, 6), new Object[]
			{
					" B ",
					"BbB",
					" B ",
					...
					bar,
					'b',
					Item.getItemFromBlock(Blocks.stone_button)
			});
	}
