...
public class BlockOre2 extends BlockOre
{
	...
	public BlockOre2(String id, Item drop, int xp, int xpRandom, int amount, int amountRandom)
	{
		super();
		this.drop = drop;
		this.amount = amount;
		...
		M.registerBlock(id, this);
	}

	public BlockOre2(String id, Item drop, int xp, int xpRandom, int amount)
	{
		this(id, drop, xp, xpRandom, amount, 0);
	}

	public BlockOre2(String id, Item drop, int xp, int xpRandom)
	{
		this(id, drop, xp, xpRandom, 1);
	}
