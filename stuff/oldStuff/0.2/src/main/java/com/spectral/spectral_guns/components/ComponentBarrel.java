...
public abstract class ComponentBarrel extends ComponentGeneric
{
	...
	{
		super("barrel_" + id, "barrel." + name, required, incapatible, true, Type.BARREL, material);
		this.spread = spread;
	...
	public static class ComponentBarrelThin extends ComponentBarrel
	{
		...
		{
			super("thin", "thin", required, incapatible, material, 0.4F, velocity);
		}
	...
	public static class ComponentBarrelNormal extends ComponentBarrel
	{
		...
		{
			super("normal", "normal", required, incapatible, material, 3.5F, velocity);
		}
	...
	public static class ComponentBarrelWide extends ComponentBarrel
	{
		...
		{
			super("wide", "wide", required, incapatible, material, 18.0F, velocity);
		}
