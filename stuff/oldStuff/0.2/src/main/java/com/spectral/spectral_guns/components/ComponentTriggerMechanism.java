...
public class ComponentTriggerMechanism extends ComponentGeneric
{
	...
	private ComponentTriggerMechanism(Component[] required, Component[] incapatible, ComponentMaterial material, float delay, boolean redstone)
	{
		super("trigger" + (redstone ? "_redstone" : ""), "trigger" + (redstone ? ".redstone" : ""), required, incapatible, true, Type.TRIGGER, material);
		this.delay = delay;
