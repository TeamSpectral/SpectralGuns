...
public class ComponentEvents
{
	...
	{
		ArrayList<Type> rts = ComponentRegister.getComponentTypes(cs);
	...
	{
		if(!isGunValid(stack) || ItemGun.ammo(stack, player)+1 > ItemGun.capacity(stack, player))
		{
			return false;
		}
	...
	{
		if(!isGunValid(stack) || ItemGun.ammo(stack, player)-1 < 0)
		{
			return false;
		}
